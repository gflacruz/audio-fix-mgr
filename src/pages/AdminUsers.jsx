              ...
              <tr key={u.id} className="hover:bg-zinc-800/30">
                ...
                <td className="p-4 text-right">
                  <button 
                    ...
                    className="text-zinc-500 hover:text-amber-500 transition-colors mr-3"
        ...
        <div className="fixed inset-0 bg-black/70 flex items-center justify-center z-50 p-4">
          <div className="bg-zinc-900 border border-zinc-700 rounded-xl p-6 w-full max-w-md shadow-xl">
            <h3 className="text-xl font-bold text-white mb-4 flex items-center gap-2">
              <Key className="text-amber-500" /> Reset Password
            </h3>
            <p className="text-zinc-400 mb-6">
              Enter a new password for user <span className="text-white font-semibold">{resetModal.username}</span>.
            </p>
            ...
            <form onSubmit={confirmPasswordReset}>
              <div className="mb-6">
                ...
                <input 
                  ...
                  className="w-full bg-zinc-950 border border-zinc-700 rounded p-3 text-white focus:outline-none focus:border-amber-500 transition-colors"
