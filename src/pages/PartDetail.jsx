  ...
  return (
    <div className="p-8 max-w-5xl mx-auto text-zinc-100">
      ...
      <div className="bg-zinc-900 rounded-xl border border-zinc-800 overflow-hidden shadow-xl">
        {/* Header */}
        <div className="bg-zinc-950 px-8 py-6 border-b border-zinc-800 flex justify-between items-start">
          <div>
          ...
          {isAdmin && !isEditing && (
            <div className="flex gap-3">
              ...
              <button 
                ...
                className="bg-red-900/20 hover:bg-red-900/40 text-red-400 px-4 py-2 rounded-lg flex items-center gap-2 transition-colors border border-red-900/30"
              >
                <Trash2 size={18} />
                Delete
              </button>
        ...
        <div className="p-8">
          {isEditing ? (
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
               <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                  ...
                  <div className="space-y-6">
                     <div>
                        <label className="block text-sm font-medium text-zinc-400 mb-2">Part Image</label>
                         <div className="space-y-3">
                            {formData.previewUrl ? (
                                <div className="relative w-full aspect-video bg-zinc-950 border border-zinc-800 rounded-lg overflow-hidden group">
                                ...
                                <div className="w-full aspect-video bg-zinc-950 border-2 border-dashed border-zinc-800 rounded-lg flex flex-col items-center justify-center text-zinc-500">
                                    <Package size={48} className="mb-2 opacity-20" />
                                    <span>No image selected</span>
                                </div>
                            )}
                            
                            <label className="flex items-center justify-center w-full px-4 py-2 bg-zinc-800 hover:bg-zinc-700 border border-zinc-700 rounded-lg cursor-pointer transition-colors text-sm">
                  ...
                  <div className="space-y-6">
                      ...
                      <div className="grid grid-cols-2 gap-4">
                        <div>
                          ...
                          <div className="relative">
                             <DollarSign className="absolute left-3 top-1/2 transform -translate-y-1/2 text-zinc-600" size={14} />
                             <input 
                                type="number" 
                                step="0.01"
                                min="0"
                                ...
                                className="w-full bg-zinc-950 border border-zinc-800 rounded-lg pl-8 pr-3 py-2 text-white focus:border-amber-500 focus:outline-none"
                              />
                          </div>
                        </div>
                        <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
               {/* Left: Image */}
               <div className="bg-zinc-950 border border-zinc-800 rounded-xl overflow-hidden flex items-center justify-center min-h-[300px]">
                  {part.imageUrl ? (
               ...
               <div className="space-y-8">
                  <div className="grid grid-cols-2 gap-6">
                      <div className="bg-zinc-950 p-4 rounded-lg border border-zinc-800">
                          ...
                          <div className="text-2xl font-mono text-emerald-400">${part.retailPrice.toFixed(2)}</div>
                      </div>
                      <div className="bg-zinc-950 p-4 rounded-lg border border-zinc-800">
                          <div className="text-zinc-500 text-sm mb-1">Wholesale Price</div>
                          <div className="text-2xl font-mono text-zinc-300">${part.wholesalePrice.toFixed(2)}</div>
                      </div>
                  </div>

                  <div>
                      <h3 className="text-lg font-medium text-white mb-2">Description</h3>
                      <div className="text-zinc-400 leading-relaxed bg-zinc-950/50 p-4 rounded-lg border border-zinc-800/50 min-h-[100px]">
                      ...
                      <div>
                          ...
                          <div className="flex flex-wrap gap-2">
                              {part.aliases.map((alias, i) => (
                                  <span key={i} className="bg-zinc-800 px-3 py-1 rounded-full text-zinc-300 border border-zinc-700 text-sm">
                                      {alias}
                                  </span>
                              ))}
                          </div>
